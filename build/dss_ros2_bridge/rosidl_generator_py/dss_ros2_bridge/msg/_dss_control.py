...
class Metaclass_DssControl(type):
    """Metaclass of message 'DssControl'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('dss_ros2_bridge')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'dss_ros2_bridge.msg.DssControl')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__dss_control
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__dss_control
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__dss_control
            cls._TYPE_SUPPORT = module.type_support_msg__msg__dss_control
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__dss_control
...
class DssControl(metaclass=Metaclass_DssControl):
    """Message class 'DssControl'."""
