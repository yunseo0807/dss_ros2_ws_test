...
bool dss_ros2_bridge__msg__dss_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dss_ros2_bridge.msg._dss_control.DssControl", full_classname_dest, 43) == 0);
  }
  dss_ros2_bridge__msg__DssControl * ros_message = _ros_message;
  {  // steer
...
{
  /* NOTE(esteve): Call constructor of DssControl */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dss_ros2_bridge.msg._dss_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DssControl");
